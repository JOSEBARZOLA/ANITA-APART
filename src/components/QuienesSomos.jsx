...
function QuienesSomos() {
  ...
  return (
    <section ref={containerRef} className="quienes-somos-container"style={{ height: "100vh", backgroundColor: "#f1f1f1" }}>
      <div className={`text-left ${visible ? "slide-in-left" : "slide-out-left"}`}>
          <p>Anita Apart es un acogedor complejo de departamentos situado a solo 500 metros del centro, en un barrio tranquilo que invita a la relajación. Disfruta de vistas panorámicas desde nuestro jardín y piscina, el lugar perfecto para desconectarte y renovar energías durante tus vacaciones.</p>
          ...
          <p>Contamos con dos unidades equipadas con cocina-comedor, habitación, baño, aire acondicionado y calefacción eléctrica, diseñadas para alojar de 2 a 6 personas. Además, ofrecemos servicio de blancos y amenities para mayor comodidad. También disponemos de estacionamiento techado y privado para nuestros huéspedes.</p>
      </div>
